...
class Server:
    ...
    def proxy_thread(self, client_connection_socket, client_address):
        ...
        if client_request:
            ...
            # Parsing the request line and headerrecvs sent by the client
            ...
            if resp_part == "GET":            # since the request will be of the form GET http://www.abc.com HTTP/1.1 extracting the http part
